...
import {
  ...
  Camera, GraduationCap, Server, Zap, AlertTriangle, Activity, Users, Clock
} from 'lucide-react';
...
const ALL_NEW_PACKAGES = [
  ...
  },
  {
    ...
    details: {
      ...
      roi: 'Les entreprises équipées d\'un SOC réduisent de 74% le temps de détection d\'intrusion et de 60% le coût moyen d\'un incident.',
  ...
  },
  {
    ...
    details: {
      objective: 'Donner à votre marque une présence digitale cohérente, professionnelle et mémorable dès le premier jour.',
      ...
      roi: 'Une marque cohérente génère jusqu\'à 23% de revenus supplémentaires. Un lancement structuré réduit le coût d\'acquisition client de 40%.',
  ...
  },
  {
    ...
    details: {
      objective: 'Maximiser votre ROAS en gérant vos campagnes Google et Meta de façon data-driven : ciblage précis, créatifs performants et optimisation continue du budget.',
      ...
      roi: 'Nos clients enregistrent en moyenne un ROAS de 4x à 7x après 90 jours. Réduction du CPA de 35% dès le 2ème mois.',
  ...
  },
  {
    ...
    details: {
      ...
      phases: ['Audit des points sensibles à surveiller','Conception du plan de câblage et placement caméras','Installation des caméras et du NVR/DVR','Configuration de l\'accès distant sécurisé','Paramétrage détection IA et alertes','Formation des responsables à l\'utilisation','Test complet du système et réception','Mise en place du contrat de maintenance'],
      ...
      maintenance: 'Contrat de maintenance trimestrielle — nettoyage objectifs, vérification enregistrements, mise à jour firmware.',
  ...
  },
  {
    ...
    features: ['Lecteurs biométriques (empreinte + visage)','Badges RFID personnalisés','Gestion multi-sites centralisée','Historique complet des accès','Blocage instantané à distance','Intégration présence & pointage','Alertes intrusion temps réel','Rapport d\'activité quotidien'],
    details: {
      objective: 'Maîtriser totalement l\'accès à vos locaux : savoir qui entre, quand et où, bloquer instantanément tout accès non autorisé, et générer automatiquement des rapports de présence pour votre RH.',
      phases: ['Audit des zones à contrôler et niveaux d\'accès','Plan d\'installation des lecteurs et serrures','Installation des lecteurs biométriques/RFID','Configuration des profils d\'accès par rôle','Enregistrement des empreintes et badges','Formation des administrateurs du système','Tests de sécurité et scénarios d\'intrusion','Livraison avec tableau de bord en ligne'],
      roi: 'Le contrôle d\'accès élimine 100% des accès non autorisés et réduit les pertes liées aux intrusions internes de 85%. Le module de pointage fait économiser 40h/mois de travail RH.',
  ...
  },
  {
    ...
    description: 'Installation de systèmes d\'alarme incendie certifiés : détection précoce, sirènes automatiques et conformité aux normes.',
    price: 'À partir de 320 000 FCFA', isPopular: false, urgency: 'VITAL',
    stat: { value: '8x', label: 'plus rapide qu\'humain' },
    features: ['Détecteurs fumée & chaleur certifiés','Centrale d\'alarme intelligente','Sirènes intérieure & extérieure','Déclencheurs manuels d\'urgence','Signalisation lumineuse d\'évacuation','Liaison directe pompiers (option)','Test mensuel automatique','Certificat de conformité normes'],
    details: {
      objective: 'Protéger vos vies et votre patrimoine contre les incendies grâce à un système de détection précoce certifié. Chaque minute gagnée avant l\'alerte peut sauver des vies.',
      phases: ['Audit des risques incendie par zone','Plan d\'implantation des détecteurs','Installation de la centrale et détecteurs','Câblage et raccordement des sirènes','Paramétrage des seuils d\'alarme','Test complet et simulation d\'évacuation','Formation du personnel aux procédures','Délivrance du certificat de conformité'],
      roi: 'Un incendie non détecté à temps peut détruire des années de travail. Nos systèmes permettent d\'intervenir 8x plus rapidement qu\'une détection humaine.',
  ...
  },
  {
    ...
    description: 'Formation intensive aux métiers des réseaux informatiques : installation, configuration, dépannage et administration réseau.',
    price: 'À partir de 180 000 FCFA', isPopular: false, urgency: 'Carrière',
    stat: { value: '89%', label: 'taux d\'insertion pro' },
    features: ['Cours TCP/IP, LAN, WAN, WiFi','Configuration routeurs & switches Cisco','Administration réseau Windows/Linux','Câblage RJ45 et fibre optique','Dépannage et diagnostic réseau','Préparation certification CCNA','Travaux pratiques sur maquettes réelles','Attestation de formation reconnue'],
    details: {
      objective: 'Former des techniciens réseau opérationnels immédiatement, capables d\'installer, configurer et maintenir des infrastructures réseau en entreprise. Programme orienté 70% pratique.',
      phases: ['Fondamentaux des réseaux et modèle OSI','Adressage IP et sous-réseaux','Configuration switches et routeurs Cisco','Mise en place d\'un réseau d\'entreprise','Administration à distance et sécurité réseau','Câblage structuré et baie de brassage','Diagnostic et dépannage des pannes','Examen final et délivrance attestation'],
      roi: 'Un technicien réseau certifié au Cameroun gagne entre 250 000 et 600 000 FCFA/mois. 89% de nos diplômés trouvent un emploi dans les 3 mois.',
      target: 'Étudiants, techniciens en reconversion, agents IT en poste, demandeurs d\'emploi',
      techStack: ['Cisco Packet Tracer','GNS3','Routeurs Cisco 2900','Switches Catalyst','Câblage Cat6','Wireshark'],
      maintenance: 'Accès e-learning 6 mois post-formation + groupe WhatsApp alumni actif.',
      alertMsg: 'Le Cameroun manque de 15 000 techniciens réseau qualifiés. Cette formation vous propulse en tête du marché.',
    }
  },
  {
    id: 205, category: 'Formation', title: 'CamTech Academy — CCTV',
    description: 'Formation professionnelle à l\'installation et maintenance de systèmes de vidéosurveillance : devenez technicien CCTV certifié.',
    price: 'À partir de 150 000 FCFA', isPopular: false, urgency: 'Demandé',
    stat: { value: '+400%', label: 'demande marché Cameroun' },
    features: ['Technologie IP & analogique CCTV','Installation caméras dôme, bullet, PTZ','Configuration NVR/DVR et stockage','Câblage coaxial et réseau IP','Paramétrage accès à distance','Maintenance préventive & curative','Lecture des plans d\'installation','Attestation technicien CCTV certifié'],
    details: {
      objective: 'Former des techniciens CCTV autonomes capables d\'installer, configurer et maintenir tout type de système de vidéosurveillance. Le marché camerounais connaît une explosion de la demande.',
      phases: ['Introduction aux systèmes CCTV analogiques et IP','Types de caméras et leurs applications','Installation physique et câblage structuré','Configuration NVR/DVR Hikvision & Dahua','Paramétrage réseaux et accès à distance','Détection IA et configuration alertes','Maintenance et diagnostic de pannes','Projet final : installation complète d\'un site'],
      roi: 'Un technicien CCTV indépendant facture entre 50 000 et 200 000 FCFA par installation. La formation est rentabilisée dès le premier mois d\'activité.',
      target: 'Techniciens électriciens, agents de sécurité, entrepreneurs, étudiants en électronique',
      techStack: ['Caméras Hikvision 4K','DVR Dahua 8 canaux','Application Hik-Connect','Câblage RG59','Testeur CCTV','Multimètre'],
      maintenance: 'Support technique WhatsApp 3 mois + tarifs préférentiels sur le matériel.',
  ...
  },
  {
    ...
    features: ['HTML5, CSS3, JavaScript ES6+','React.js & Node.js fullstack','Base de données MySQL & MongoDB','API REST et intégrations','Git & déploiement sur Vercel/Heroku','Responsive design & mobile-first','3 projets réels dans le portfolio','Certificat de développeur web'],
    details: {
      objective: 'Transformer des débutants en développeurs web fullstack employables en 3 mois, avec un portfolio de projets réels. Formation 100% pratique, orientée marché camerounais et africain.',
      phases: ['Fondamentaux HTML/CSS et design responsive','JavaScript ES6+ et logique de programmation','React.js : composants, hooks, état, routing','Node.js & Express : API REST et authentification','Base de données MySQL et MongoDB','Déploiement cloud et CI/CD basique','Projet 1 : Site vitrine professionnel','Projet 2 : Application CRUD fullstack','Projet 3 : Plateforme e-commerce complète','Préparation CV, entretiens et portfolio'],
      roi: 'Un développeur web junior au Cameroun gagne entre 300 000 et 700 000 FCFA/mois. En freelance, les projets démarrent à 200 000 FCFA.',
      target: 'Étudiants, professionnels en reconversion, entrepreneurs, passionnés d\'informatique',
      techStack: ['VS Code','HTML5/CSS3','JavaScript ES6+','React.js','Node.js','MySQL','MongoDB','Git/GitHub'],
      maintenance: 'Accès à vie aux supports de cours + groupe Discord alumni + 3 sessions de mentoring post-formation.',
  ...
  },
  {
    ...
    features: ['Câblage structuré Cat6/Fibre optique','WiFi entreprise haute densité (Ubiquiti/Cisco)','VPN sécurisé multi-sites','Administration centralisée (dashboard)','QoS et priorisation du trafic','VLAN et segmentation réseau','Firewall et filtrage de contenu','Support & supervision inclus 12 mois'],
    details: {
      objective: 'Construire une infrastructure réseau professionnelle, fiable et sécurisée qui supporte la croissance de votre entreprise. Nos déploiements garantissent 99,9% d\'uptime.',
      phases: ['Audit de l\'existant et des besoins réseau','Conception de l\'architecture réseau','Plan de câblage et installation baie de brassage','Déploiement des équipements actifs','Configuration VLAN, QoS et sécurité','Installation du WiFi et tests de couverture','Mise en place VPN et accès distants','Formation des équipes IT internes','Tests de charge et validation finale','Livraison avec documentation complète'],
      roi: 'Un réseau professionnel réduit de 70% les temps d\'arrêt. La productivité de vos équipes augmente de 35%. ROI visible dès le 1er mois.',
      target: 'PME en croissance, bureaux multi-étages, hôtels, écoles, cliniques, administrations au Cameroun',
      ...
      alertMsg: 'Un réseau lent fait perdre à votre équipe jusqu\'à 2h de productivité par jour. Calculez vos pertes.',
    }
  },
];
...
const urgencyColors: Record<string, string> = {
  ...
  'Carrière': 'bg-amber-600', 'Demandé': 'bg-orange-500', 'Populaire': 'bg-pink-600',
};

// ─── STAT ITEM — hook utilisé au niveau composant, PAS dans un .map() ────────
const StatItem: React.FC<{ val: number; suffix: string; label: string; icon: React.ReactNode; delay: number; inView: boolean }> = ({ val, suffix, label, icon, delay, inView }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-3" style={{ animation: inView ? `fadeSlideUp 0.6s ${delay}ms both` : 'none' }}>
      <div className="text-brand-orange">{icon}</div>
      <div className="text-4xl font-black tracking-tighter text-white">{count}{suffix}</div>
      <div className="text-brand-sand/60 text-xs font-black uppercase tracking-widest">{label}</div>
    </div>
  );
};
  ...
  return (
    <div ref={ref} className="py-16 bg-brand-stone overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center text-white">
        {stats.map((s, i) => (
          <StatItem key={i} {...s} delay={i * 150} inView={inView} />
        ))}
      </div>
    </div>
  );
...
const PackageCard: React.FC<{ p: any; idx: number; onClick: () => void }> = ({ p, idx, onClick }) => {
  ...
  return (
    <div ref={ref} onClick={onClick}
      style={{ animation: inView ? `cardReveal 0.7s ${(idx % 3) * 100}ms both` : 'none' }}
      className={`relative bg-white rounded-[2.5rem] border-2 transition-all duration-500 cursor-pointer group flex flex-col overflow-hidden hover:-translate-y-2 hover:shadow-2xl
        ${p.isPopular ? 'shadow-2xl' : 'border-brand-sand shadow-md hover:border-brand-orange/50'}`}
      onMouseEnter={e => { if (!p.isPopular) (e.currentTarget as HTMLElement).style.borderColor = cfg.color + '80'; }}
      onMouseLeave={e => { if (!p.isPopular) (e.currentTarget as HTMLElement).style.borderColor = ''; }}>

      {p.isPopular && (
        <div className="absolute -top-1 left-1/2 -translate-x-1/2 z-10">
          <div className="text-white px-5 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5 shadow-xl"
      ...
      <div className={`absolute top-6 right-6 text-white text-[8px] font-black uppercase tracking-widest px-3 py-1 rounded-full ${urgencyColors[p.urgency] || 'bg-brand-stone'}`}>
        {p.urgency}
      </div>
      ...
      <div className="p-8 flex flex-col flex-grow">
        ...
        <h3 className="text-xl font-black text-brand-stone uppercase tracking-tighter mb-3 leading-tight transition-colors duration-300 group-hover:text-brand-orange">
          {p.title}
        </h3>
...
const PackagesPage: React.FC = () => {
  ...
  const ALL_PACKAGES = [...(PACKAGES as any[]), ...ALL_NEW_PACKAGES];
  ...
  return (
    <>
      <style>{`
        ...
        .hero-d0 { animation: heroIn 0.8s 0.1s both; }
        .hero-d1 { animation: heroIn 0.8s 0.2s both; }
        .hero-d2 { animation: heroIn 0.8s 0.3s both; }
        .hero-d3 { animation: heroIn 0.8s 0.4s both; }
      ...
      <div className="bg-brand-cream min-h-screen pt-24">
        ...
        <section className="relative bg-white overflow-hidden border-b border-brand-sand">
          ...
          <div className="max-w-7xl mx-auto px-4 py-24 sm:py-32 relative z-10">
            <div className="max-w-4xl">
              <div className="hero-d0 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-orange/10 border border-brand-orange/20 mb-8">
                <Zap size={12} className="text-brand-orange" />
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-brand-orange">{ALL_PACKAGES.length} Solutions Prêtes à Déployer</span>
              </div>
              <h1 className="hero-d1 text-6xl sm:text-8xl lg:text-[100px] font-black uppercase tracking-tighter leading-[0.88] text-brand-stone mb-8">
                Nos <span className="text-brand-orange">Packages</span><br />
                <span className="text-brand-stone/20">Stratégiques</span>
              </h1>
              <p className="hero-d2 text-lg sm:text-xl text-brand-stone/50 font-bold leading-relaxed max-w-2xl mb-12">
              ...
              <div className="hero-d3 flex flex-wrap gap-6">
                {[{ icon: <Shield size={16} />, label: 'Garantie de résultat' },{ icon: <Clock size={16} />, label: 'Déploiement rapide' },{ icon: <Users size={16} />, label: 'Support local' }].map((b, i) => (
          ...
          <div className="absolute bottom-8 right-8 hidden lg:flex flex-col items-center gap-1 text-brand-stone/10">
            <div className="text-[80px] font-black leading-none">{ALL_PACKAGES.length}</div>
        ...
        <div className="sticky top-[72px] z-30 bg-white/90 backdrop-blur-xl border-b border-brand-sand shadow-sm">
          <div className="max-w-7xl mx-auto px-4 py-4 flex flex-wrap gap-2 justify-center">
            {categories.map(c => {
              const count = c === 'Tous' ? ALL_PACKAGES.length : ALL_PACKAGES.filter((p: any) => p.category === c).length;
              return (
                <button key={c} onClick={() => setFilter(c)}
                  className={`px-5 py-2.5 rounded-full text-[9px] font-black uppercase tracking-widest transition-all duration-300 border-2 ${
                    filter === c ? 'bg-brand-stone text-white border-brand-stone shadow-lg scale-105' : 'bg-white text-brand-stone/50 border-brand-sand hover:border-brand-orange hover:text-brand-orange'
                  }`}>
                  {c} <span className={`ml-1 text-[8px] ${filter === c ? 'text-brand-orange' : 'text-brand-stone/20'}`}>({count})</span>
                </button>
              );
            })}
          </div>
          ...
          <div className="relative z-10 py-16 px-8 flex flex-col sm:flex-row items-center justify-between gap-8">
            <div>
              ...
              <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tighter text-white leading-tight">
                Audit personnalisé<br /><span className="text-white/40">GRATUIT</span>
              </h2>
            </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-[9px] font-black uppercase tracking-[0.4em]" style={{ color: cfg.color }}>{selectedPackage.category}</span>
                    <span className={`text-[8px] font-black uppercase px-2 py-0.5 text-white rounded ${urgencyColors[selectedPackage.urgency] || 'bg-brand-stone'}`}>{selectedPackage.urgency}</span>
                  </div>
                  <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tighter text-brand-stone leading-tight">{selectedPackage.title}</h2>
                </div>
              </div>
              <button onClick={closeModal} className="shrink-0 w-10 h-10 rounded-full border-2 border-brand-sand flex items-center justify-center hover:bg-brand-orange hover:border-brand-orange hover:text-white transition-all">
                <X size={18} />
              </button>
            </div>

            {selectedPackage.details?.alertMsg && (
              <div className="mx-6 sm:mx-10 mt-6 p-4 rounded-2xl flex items-start gap-3" style={{ background: cfg.bg }}>
                <AlertTriangle size={18} className="shrink-0 mt-0.5" style={{ color: cfg.color }} />
                <p className="text-[11px] font-black uppercase tracking-tight" style={{ color: cfg.color }}>{selectedPackage.details.alertMsg}</p>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                <div className="lg:col-span-7 space-y-12">
                  <div>
                    ...
                    <p className="text-lg text-brand-stone font-bold leading-relaxed border-l-4 pl-6" style={{ borderColor: cfg.color }}>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {selectedPackage.details?.phases.map((phase: string, i: number) => (
                        <div key={i} className="flex items-center gap-4 bg-brand-beige/40 p-4 rounded-2xl border border-brand-sand/30 hover:border-brand-orange/30 transition-all">
                          <div className="w-7 h-7 rounded-full text-white flex items-center justify-center font-black text-[10px] shrink-0" style={{ background: cfg.color }}>{i + 1}</div>
                  ...
                  <div>
                    ...
                    <div className="bg-brand-beige p-8 rounded-[2rem] border border-brand-sand">
                      <p className="text-base text-brand-stone/70 font-bold leading-relaxed italic">"{selectedPackage.details?.roi}"</p>
                    </div>
                  </div>
                </div>

                <div className="lg:col-span-5 space-y-6">
                  <div className="p-8 rounded-[2rem] text-white" style={{ background: cfg.color }}>
                  ...
                  <div className="p-6 rounded-[2rem] border-2 border-dashed flex items-start gap-3"
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-brand-stone/50 leading-relaxed uppercase">Audit de fin de chantier certifié + garantie de performance sur chaque prestation.</p>
                    </div>
                  </div>
                </div>
              </div>
